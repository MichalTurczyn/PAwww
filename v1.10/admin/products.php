...
function PokazProdukty()
{
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        $zdjecie_base64 = $row['zdjecie'] ? 'data:image/jpeg;base64,' . base64_encode($row['zdjecie']) : null;
        $miniatura = $zdjecie_base64 ? '<img src="' . $zdjecie_base64 . '" alt="Zdjęcie" width="80" height="80">' : 'Brak zdjęcia';
